			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">Edit Gejala <?= $dat['kode_gejala'] ?></h4>
					</div>
					<div class="modal-body">
						<form class="form-horizontal" action="<?= base_url('e-gjl') ?>" method="POST">
							<div class="box-body">
		...
		<div class="modal modal-danger fade" id="modal-danger<?= $dat['id'] ?>">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form class="form-horizontal" action="<?= base_url('h-gjl') ?>" method="POST">
							<div class="box-body">
								<div class="form-group">
									<label for="inputEmail3" class="col-sm-2 control-label">Kode Gejala</label>

									<div class="col-sm-10">
										<input type="text" name="kode" readonly class="form-control" id="inputEmail3" placeholder="<?= $dat['kode_gejala'] ?>">
										<input type="hidden" name="id" value="<?= $dat['id'] ?>">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="nama" readonly class="form-control" id="inputPassword3" placeholder="<?= $dat['nama_gejala'] ?>">
									</div>
								</div>
	...
	<div class="modal modal-info fade" id="modal-info">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal" action="<?= base_url('t-gjl') ?>" method="POST">
						<div class="box-body">
							<div class="form-group">
								<label for="inputEmail3" class="col-sm-2 control-label">Kode Gejala</label>

								<div class="col-sm-10">
									<input type="text" name="kode" class="form-control" id="inputEmail3" placeholder="Kode Gejala">
									<!-- <input type="hidden" name="id" value="<?= $dat['id'] ?>"> -->
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="nama" class="form-control" id="inputPassword3" placeholder="Nama Gejala">
								</div>
							</div>
